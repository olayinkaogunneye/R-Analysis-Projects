...
Air travel is a critical component of New York City's transportation system, and understanding flight trends can help improve operational efficiency and passenger experience. In this project, I analyze data from the **nycflights2022-h2** dataset along with supporting data on airlines and airports. My analysis focuses on:
...
Next, I join the flights, airlines, and airports datasets together. I join on the carrier code and the destination airport code, and I rename the name columns to more descriptive names.
...
Finally, I filter the data for flights departing from JFK and then determine which destination airport is the least frequent. I store the result as a character string called least.
```{r}
